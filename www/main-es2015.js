...
const routes = [
    ...
    {
        path: 'presentations',
        loadChildren: () => __webpack_require__.e(/*! import() | presentations-presentations-module */ "presentations-presentations-module").then(__webpack_require__.bind(null, /*! ./presentations/presentations.module */ "./src/app/presentations/presentations.module.ts")).then(m => m.PresentationsPageModule),
        canLoad: [
            _auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]
        ]
    },
    {
        path: 'activities',
        loadChildren: () => __webpack_require__.e(/*! import() | activities-activities-module */ "activities-activities-module").then(__webpack_require__.bind(null, /*! ./activities/activities.module */ "./src/app/activities/activities.module.ts")).then(m => m.ActivitiesPageModule),
        canLoad: [
            _auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]
        ]
    },
...
module.exports = __webpack_require__(/*! C:\Users\caleb\Documents\Work\Set_Me_Free_App\src\main.ts */"./src/main.ts");
